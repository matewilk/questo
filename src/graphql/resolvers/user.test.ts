            ...
            dataSources: {
                questoSource: {
                    ...
                    getRecord: jest.fn().mockImplementation(() => (
                        { ID: "USR_123", RecordType: "USR", text: "Bob Swarovski", score: 0, type: "USER", date: 819170640000 /* 1995-12-17T03:24:00 */ }
                    ))
                }
            }
        };
    ...
    describe("Query", () => {
        ...
        describe("user resolver", () => {
            it("should call getRecord questoSource method and return user record", async () => {
                const args = { ID: "USR_123", RecordType: `${process.env.USER_PREFIX}` };
