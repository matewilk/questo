...
describe("Answer", () => {
    ...
    beforeAll(async () => {
        ...
        await answerQuestion({ QUE_ID: testQuestion.ID, text: "Adam", score: 10, type: "test" });
        await answerQuestion({ QUE_ID: testQuestion.ID, text: "Bob", score: 20, type: "test" });
        await answerQuestion({ QUE_ID: testQuestion.ID, text: "Natalie", score: 30, type: "test" });
    });
